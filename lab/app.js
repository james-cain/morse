...
(function (factory) {
	...
	*/
	...
	var Morse = function () {
	  ...
	  _createClass(Morse, [{
	    ...
	    value: function _addListener() {
	      ...
	      this._registTapStartEvent = function (e) {
	        _this._registTapStartFunc(e);
	      };
	      this._registTapEndEvent = function (e) {
	        _this._registTapEndFunc(e);
	      };
	    ...
	    key: '_matchCode',
	    value: function _matchCode(morseCode) {
	      var code = this.options.code;
	      var codeStr = morseCode.join('');
	      if (codeStr === code) {
	    ...
	    key: '_registTapStartFunc',
	    value: function _registTapStartFunc(e) {
	      this._stopTimer();
	    ...
	    key: '_registTapEndFunc',
	    value: function _registTapEndFunc(e) {
	    ...
	    key: '_transformCode',
	    value: function _transformCode() {
	      var distanceXAbs = Math.abs(this.distanceX);
	      var distanceYAbs = Math.abs(this.distanceY);
	...
	var short = document.querySelector('.code-short-tap');
	var long = document.querySelector('.code-long-tap');
	var up = document.querySelector('.code-up');
	var down = document.querySelector('.code-down');
	var left = document.querySelector('.code-left');
	var right = document.querySelector('.code-right');
